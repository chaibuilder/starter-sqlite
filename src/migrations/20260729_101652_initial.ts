...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "ai_addon_purchases" (
  ...
  CREATE TABLE "ai_credit_addons" (
  	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
  	"createdAt" timestamp with time zone DEFAULT now() NOT NULL,
  	"user" text NOT NULL,
  	"client" uuid,
  	"creditsTotal" numeric NOT NULL,
  	"creditsUsed" numeric DEFAULT '0' NOT NULL,
  	"purchaseId" text,
  ...
  CREATE TABLE "app_redirects" (
  	...
  	"createdBy" text,
  	CONSTRAINT "app_redirects_app_fromPath_unique" UNIQUE("app","fromPath")
  );
  
  CREATE TABLE "app_trash" (
  	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
  ...
  CREATE TABLE "client_users" (
  	...
  	CONSTRAINT "client_users_user_client_unique" UNIQUE("user","client")
  );
  ...
  ALTER TABLE "ai_addon_purchases" ADD CONSTRAINT "ai_addon_purchases_client_fkey" FOREIGN KEY ("client") REFERENCES "public"."clients"("id") ON DELETE no action ON UPDATE no action;
  ALTER TABLE "ai_credit_addons" ADD CONSTRAINT "ai_credit_addons_client_fkey" FOREIGN KEY ("client") REFERENCES "public"."clients"("id") ON DELETE no action ON UPDATE no action;
  ...
  ALTER TABLE "app_api_keys" ADD CONSTRAINT "app_api_keys_app_fkey" FOREIGN KEY ("app") REFERENCES "public"."apps"("id") ON DELETE no action ON UPDATE no action;
  ...
  ALTER TABLE "app_domains" ADD CONSTRAINT "app_domains_app_fkey" FOREIGN KEY ("app") REFERENCES "public"."apps"("id") ON DELETE no action ON UPDATE no action;
  ALTER TABLE "app_form_submissions" ADD CONSTRAINT "app_form_submissions_app_fkey" FOREIGN KEY ("app") REFERENCES "public"."apps"("id") ON DELETE no action ON UPDATE no action;
  ...
  ALTER TABLE "app_pages_revisions" ADD CONSTRAINT "app_pages_revisions_app_fkey" FOREIGN KEY ("app") REFERENCES "public"."apps"("id") ON DELETE no action ON UPDATE no action;
  ALTER TABLE "app_redirects" ADD CONSTRAINT "app_redirects_app_fkey" FOREIGN KEY ("app") REFERENCES "public"."apps"("id") ON DELETE no action ON UPDATE no action;
  ALTER TABLE "app_trash" ADD CONSTRAINT "trash_app_fkey" FOREIGN KEY ("app") REFERENCES "public"."apps"("id") ON DELETE no action ON UPDATE no action;
  ALTER TABLE "app_user_addons" ADD CONSTRAINT "app_user_addons_client_fkey" FOREIGN KEY ("client") REFERENCES "public"."clients"("id") ON DELETE no action ON UPDATE no action;
  ALTER TABLE "app_user_plans" ADD CONSTRAINT "app_user_plans_client_fkey" FOREIGN KEY ("client") REFERENCES "public"."clients"("id") ON DELETE no action ON UPDATE no action;
  ...
  ALTER TABLE "client_users" ADD CONSTRAINT "client_users_client_fkey" FOREIGN KEY ("client") REFERENCES "public"."clients"("id") ON DELETE no action ON UPDATE no action;
  ALTER TABLE "invited_users" ADD CONSTRAINT "invited_users_app_fkey" FOREIGN KEY ("app") REFERENCES "public"."apps"("id") ON DELETE no action ON UPDATE no action;
  ALTER TABLE "invited_users" ADD CONSTRAINT "invited_users_client_fkey" FOREIGN KEY ("client") REFERENCES "public"."clients"("id") ON DELETE no action ON UPDATE no action;
  ...
  ALTER TABLE "webhook_events" ADD CONSTRAINT "webhook_events_clientId_fkey" FOREIGN KEY ("clientId") REFERENCES "public"."clients"("id") ON DELETE no action ON UPDATE no action;
  ...
  CREATE INDEX "ai_addon_purchases_user_idx" ON "ai_addon_purchases" USING btree ("user" text_ops);
  CREATE INDEX "ai_credit_addons_status_idx" ON "ai_credit_addons" USING btree ("status" text_ops);
  CREATE INDEX "ai_credit_addons_user_idx" ON "ai_credit_addons" USING btree ("user" text_ops);
  ...
  CREATE INDEX "idx_app_redirects_app_toPath" ON "app_redirects" USING btree ("app","toPath");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   DROP TABLE "ai_addon_purchases" CASCADE;
  DROP TABLE "ai_credit_addons" CASCADE;
  DROP TABLE "ai_logs" CASCADE;
  DROP TABLE "app_api_keys" CASCADE;
  DROP TABLE "app_assets" CASCADE;
  DROP TABLE "app_domains" CASCADE;
  DROP TABLE "app_form_submissions" CASCADE;
  DROP TABLE "app_pages" CASCADE;
  DROP TABLE "app_pages_online" CASCADE;
  DROP TABLE "app_pages_revisions" CASCADE;
  DROP TABLE "app_redirects" CASCADE;
  DROP TABLE "app_trash" CASCADE;
  DROP TABLE "app_user_addons" CASCADE;
  DROP TABLE "app_user_plans" CASCADE;
  DROP TABLE "app_users" CASCADE;
  DROP TABLE "apps" CASCADE;
  DROP TABLE "apps_online" CASCADE;
  DROP TABLE "client_users" CASCADE;
  DROP TABLE "clients" CASCADE;
  DROP TABLE "invited_users" CASCADE;
